...
?>
    ...
    font-size: 1.5rem;
    color: #393a9e;">Unfortunately in the location you have chosen there are no bikes, we show to you bike in Bali Kuta</p>


        <form action='/third' name='go_third' id='go_third' method='post'>
