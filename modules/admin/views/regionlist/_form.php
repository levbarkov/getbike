...
<div class="region-list-form">
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <?= $form->field($model, 'alias')->textInput(['maxlength' => true, 'list' => 'alias']) ?>
<!--            <details id="alias">
                <option>1</option>
            </details>-->
        </div>
        ...
        <div class="col-md-3">
            <?= $form->field($model, 'country_id')->dropDownList($country_list) ?>

        </div><!--
        <div class="col-md-3">
            <?/*= $form->field($model, 'coord')->textInput(['placeholder' => '-8.624073|115.169085'])->label('Coordinates') */?>
        </div>-->
        <div class="col-md-12">
            <?= $form->field($model, 'tag_line')->textInput()->label('Tag line') ?>
        </div>
        <div class="col-md-12">
            <?= $form->field($model, 'adress')->textInput()->label('Default adress') ?>
        </div>
        <div class="col-md-12">
...
/*
      ...
      function initAutocomplete() {
       ...
       google.maps.event.addListener(map, 'click', function(e) {   
         ...
         $('[name="RegionList[coord]"]').val(location.lat()+'|'+location.lng());
         deleteMarkers();
        addMarker(location);
        ...
        searchBox.addListener('places_changed', function() {
          ...
          places.forEach(function(place) {
            ...
            $('[name="RegionList[coord]"]').val(place.geometry.location.lat()+'|'+place.geometry.location.lng());
